...
# test codecov darwin py311-test

![test codecov darwin py311-test banner](docs/_static/banner.svg)
<div align="center">
    <p>
        <em>
            A Python package.
    ...
    <p>
        ...
        <a href="https://github.com/whiteprints-tests/test-codecov-darwin-py311-test/discussions"><img alt="GitHub Discussions" src="https://img.shields.io/github/discussions/whiteprints-tests/test-codecov-darwin-py311-test.svg?logo=GitHub"></a>
        ...
        <a href="https://codecov.io/gh/whiteprints-tests/test-codecov-darwin-py311-test" ><img alt="codecov badge" src="https://codecov.io/gh/whiteprints-tests/test-codecov-darwin-py311-test/graph/badge.svg?token="/></a>
    </p>
</div>
