...
project = "test codecov darwin py311-test"
...
release = metadata.version("test_codecov_darwin_py311_test")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-codecov-darwin-py311-test",
